...
class Simulador():
    def __init__(self):
        ...
        self._dias = None
        # FIXME dias no debiese empezar en None
    ...
    def comprobar_recuperacion_o_muerte(self, i):
        ...
        if dias_enfermo > 7:
            ...
            if dias_enfermo == 1 or dias_enfermo == 7:
                probabilidad_real = self.comunidad.enfermedad.probabilidad_de_morir / 8
            elif dias_enfermo == 2 or dias_enfermo == 6:
                probabilidad_real = self.comunidad.enfermedad.probabilidad_de_morir / 4
            elif dias_enfermo == 3 or dias_enfermo == 5:
                probabilidad_real = self.comunidad.enfermedad.probabilidad_de_morir / 2
            else:
                probabilidad_real = self.comunidad.enfermedad.probabilidad_de_morir
    ...
    # FIXME Dividan esto en funciones, no pueden haber tantos if anidados
    # por otra parte estan pasados de los 80 caractéres.
    def pandemia(self):
...
# FIXME Metan todo esto en una función. Adicionalmente, si quieren cambiar
# valores, creen constantes en el inicio del código.
def main():
    covid = Enfermedad()
